...
def publish_to_beehiiv(
    ...
    content_parts.append(
        "<hr><p><em>Generated by The Valve Wire using Claude AI. "
        "Sources: PubMed, bioRxiv, medRxiv, major cardiology journals, "
        "Google News, FDA, ClinicalTrials.gov, SEC EDGAR, Yahoo Finance.</em></p>"
    )
